...
# --- URL da API de Execução Financeira (Contrato) ---
...
def fetch_financial_data(project_id):
    ...
    all_data = []
    page = 0
    clean_pid = str(project_id).strip() # Garante a limpeza do ID logo na entrada
...
def process_and_load_data():
    ...
    for estado in estados:
        ...
        for pid in project_ids:
            ...
            # A limpeza do ID é feita dentro da função fetch_financial_data
            data_from_api = fetch_financial_data(pid)
            ...
            if data_from_api:
                ...
                # Garante que o ID do projeto esteja correto nos campos 'id_unico' e 'idProjetoInvestimento'
